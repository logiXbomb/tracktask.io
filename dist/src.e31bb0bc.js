...
},{"./v1":"../node_modules/uuid/v1.js","./v4":"../node_modules/uuid/v4.js"}],"Main.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{activeTask: flags.activeTask, mode: author$project$Main$Normal, navKey: key, pendingKey: elm$core$Maybe$Nothing, tasks: flags.tasks},
...
var author$project$Main$HandleKeyStroke = function (a) {
	return {$: 'HandleKeyStroke', a: a};
};
var author$project$Main$UpdateTaskList = function (a) {
...
var author$project$Main$keyPress = function (model) {
	return A2(
	...
	function (model, tagger) {
		return elm$browser$Browser$Events$onKeyDown(
			A2(
				elm$json$Json$Decode$map,
				tagger,
				author$project$Main$keyPress(model)));
	});
var elm$json$Json$Decode$andThen = _Json_andThen;
var author$project$Main$updateTaskList = _Platform_incomingPort(
	'updateTaskList',
	A2(
			...
			return A2(
				...
				function (activeTask) {
					return elm$json$Json$Decode$succeed(
						{activeTask: activeTask, taskList: taskList});
				},
				A2(elm$json$Json$Decode$field, 'activeTask', elm$json$Json$Decode$string));
		},
		A2(
			elm$json$Json$Decode$field,
			'taskList',
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(author$project$Main$onKeyDown, model, author$project$Main$HandleKeyStroke),
				author$project$Main$updateTaskList(author$project$Main$UpdateTaskList)
			]));
};
var author$project$Main$AddTask = {$: 'AddTask'};
var author$project$Main$Insert = {$: 'Insert'};
var elm$json$Json$Encode$null = _Json_encodeNull;
var author$project$Main$addTask = _Platform_outgoingPort(
	'addTask',
	function ($) {
		return elm$json$Json$Encode$null;
	});
var author$project$Main$moveTaskDown = _Platform_outgoingPort('moveTaskDown', elm$json$Json$Encode$string);
var author$project$Main$moveTaskUp = _Platform_outgoingPort('moveTaskUp', elm$json$Json$Encode$string);
...
var author$project$Main$nextTask = function (model) {
	var index = A2(
		elm_community$list_extra$List$Extra$findIndex,
		function (t) {
			return _Utils_eq(t.id, model.activeTask);
		},
		model.tasks);
	if (index.$ === 'Just') {
		var idx = index.a;
		return function (foundTask) {
			if (foundTask.$ === 'Just') {
				var t = foundTask.a;
				return t.id;
			} else {
			...
			A2(elm_community$list_extra$List$Extra$getAt, idx + 1, model.tasks));
	} else {
		return model.activeTask;
	}
};
var author$project$Main$prevTask = function (model) {
	var index = A2(
		elm_community$list_extra$List$Extra$findIndex,
		function (t) {
			return _Utils_eq(t.id, model.activeTask);
...
var author$project$Main$saveTaskList = _Platform_outgoingPort(
	'saveTaskList',
	elm$json$Json$Encode$list(
		function ($) {
			return elm$json$Json$Encode$object(
		...
		while (true) {
			switch (msg.$) {
				case 'AddTask':
					return _Utils_Tuple2(
						model,
						author$project$Main$addTask(_Utils_Tuple0));
				case 'UpdateTaskList':
					var rsp = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{activeTask: rsp.activeTask, tasks: rsp.taskList}),
						A2(
						...
						_Utils_update(
							model,
							{
								tasks: A2(
									elm$core$List$map,
									function (t) {
										return _Utils_eq(t.id, index) ? _Utils_update(
											t,
											{title: title}) : t;
									},
									model.tasks)
						...
						case 'Up':
							...
							if (_n3.$ === 'Just') {
								...
								return _Utils_Tuple2(
									...
									author$project$Main$moveTaskUp(model.activeTask));
							} else {
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											activeTask: author$project$Main$prevTask(model)
										}),
									elm$core$Platform$Cmd$none);
							}
						case 'InsertMode':
							...
							if (_n6.$ === 'Just') {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{pendingKey: elm$core$Maybe$Nothing}),
									author$project$Main$moveTaskDown(model.activeTask));
							} else {
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											activeTask: author$project$Main$nextTask(model)
										}),
									elm$core$Platform$Cmd$none);
							}
						case 'SetStatus':
...
var author$project$Main$icon = function (str) {
	return A2(
...
var author$project$Main$task = F2(
	function (model, t) {
		var isActive = _Utils_eq(t.id, model.activeTask);
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$px(2),
							rtfeldman$elm_css$Css$solid,
							rtfeldman$elm_css$Css$hex('5e5e5e'))
						]))
				]),
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$Main$UpdateTaskTitle(t.id))
								]),
...
var author$project$Main$taskList = function (model) {
	return A2(
		...
		A2(
			elm$core$List$map,
			author$project$Main$task(model),
			model.tasks));
};
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Track Task')
								])),
							author$project$Main$taskList(model),
	...
	A2(
		...
		function (tasks) {
			return A2(
				...
				function (activeTask) {
					return elm$json$Json$Decode$succeed(
						{activeTask: activeTask, tasks: tasks});
				},
				A2(elm$json$Json$Decode$field, 'activeTask', elm$json$Json$Decode$string));
		},
		A2(
...
var getTasks = getItem('tasks');
var setTasks = setItem('tasks');
...
if (ports && ports.addTask) {
  ports.addTask.subscribe(function () {
...
if (ports && ports.moveTaskUp) {
  ports.moveTaskUp.subscribe(function (activeTask) {
    var tl = getTasks();
    var index = tl.findIndex(function (t) {
      return t.id === activeTask;
    });
...
if (ports && ports.moveTaskDown) {
  ports.moveTaskDown.subscribe(function (activeTask) {
    var tl = getTasks();
    var index = tl.findIndex(function (t) {
      return t.id === activeTask;
    });
...
},{"uuid":"../node_modules/uuid/index.js","./Main.elm":"Main.elm"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
