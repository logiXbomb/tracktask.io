...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		return _Utils_Tuple2(
			{activeTask: 0, mode: author$project$Main$Normal, navKey: key, tasks: _List_Nil},
			...
			switch (msg.$) {
				...
				case 'AddTaskResponse':
					if (msg.a.$ === 'Ok') {
						...
						var error = msg.a.a;
						var e = A2(elm$core$Debug$log, 'ERROR', error);
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					}
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Task":{"args":[],"type":"{ title : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"AddTask":[],"AddTaskResponse":["Result.Result Main.IOError (List.List Main.Task)"],"UpdateTaskTitle":["Basics.Int","String.String"],"HandleKeyStroke":["Main.KeyPress"],"NoOp":[]}},"Main.IOError":{"args":[],"tags":{"ItFailed":[]}},"Main.KeyPress":{"args":[],"tags":{"Down":[],"Up":[],"InsertMode":[],"NormalMode":[],"AppendNewLine":[],"PrependNewLine":[],"NoOpKey":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
