...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		return _Utils_Tuple2(
			{mode: author$project$Main$Normal, tasks: _List_Nil},
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"AddTask":[],"HandleKeyStroke":["Main.KeyPress"],"NoOp":[]}},"Main.KeyPress":{"args":[],"tags":{"Down":[],"AppendNewLine":[],"PrependNewLine":[],"NoOpKey":[]}}}}})}});}(this));